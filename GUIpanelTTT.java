...
public class GUIpanelTTT extends JPanel implements ActionListener
{
	/***********************
	 * Attributes
	 ***********************/
	...
	//public Oplayer[] GamerTag;
	
	//***************************************************************************
	//Method: PanelMain()
	//
	//Purpose: To customize, Initialize & add JLabels, JTextFields, JButtons,
	//		& Player Objects.
	//			   
	//***************************************************************************
	...
	public GUIpanelTTT()
	{
		...
		//Create file to store game data
		createNewFile(tttFile);
...
//			GamerTag[PlayerID].setGamertag(gamerTagP1);
//			PlayerID++;
//			GamerTag[PlayerID].setGamertag(gamerTagP2);
//			PlayerID++;
	...
	//
	//Purpose: To create the file that will store the data about the game.
	//			   
	//***************************************************************************
	...
	public void createNewFile(String text)
	{
		...
		try
		{
			outPut = new PrintWriter(tttFile);
			System.out.println(++lineNumber+ ". Create New File Method: try");
		}
		...
		finally
		{
			...
			{
				outPut.close();
				System.out.println(++lineNumber+ ". Create New File Method: Closing");
			}
		}
	}
...
////Seventh and Eight Row
//m_topPlayersLBL[0][0] = new JLabel("Top Players: ");
//m_topPlayersLBL[0][0].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[0][0].setHorizontalAlignment(JLabel.CENTER);
//m_topPlayersLBL[0][1] = new JLabel("N/A");
//m_topPlayersLBL[0][1].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[0][1].setHorizontalAlignment(JLabel.CENTER);
//m_topPlayersLBL[0][2] = new JLabel("N/A");
//m_topPlayersLBL[0][2].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[0][2].setHorizontalAlignment(JLabel.CENTER);
//m_topPlayersLBL[1][0] = new JLabel("N/A");
//m_topPlayersLBL[1][0].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[1][0].setHorizontalAlignment(JLabel.CENTER);
//m_topPlayersLBL[1][1] = new JLabel("N/A");
//m_topPlayersLBL[1][1].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[1][1].setHorizontalAlignment(JLabel.CENTER);
//m_topPlayersLBL[1][2] = new JLabel("N/A");
//m_topPlayersLBL[1][2].setFont(new Font(Font.SANS_SERIF, Font.BOLD, 30));
//m_topPlayersLBL[1][2].setHorizontalAlignment(JLabel.CENTER);
//add(m_topPlayersLBL[0][0]); add(m_topPlayersLBL[0][1]); add(m_topPlayersLBL[0][2]);
//add(m_topPlayersLBL[1][0]); add(m_topPlayersLBL[1][1]); add(m_topPlayersLBL[1][2]);